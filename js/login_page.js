...
const PREFIX = "reach.UNIHACK.passwords.";
const SALT = "a5d%f2;Snm";

function checkPassword() {
    var username = document.getElementById("username").value;
    var password = document.getElementById("password").value;

    // checks user is registered in system
    if (localStorage.getItem(PREFIX + username) === null) {
...
function createAccount() {
    let form_space = document.getElementById("form-space");
    form_space.innerHTML = `<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
    ...
    <br />
    <button class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect" onclick="signup()">
              Create account
            </button>
            `
}
...
function signup() {
    ...
    if ((pass1 === pass2) && (pass1 !== "")) {
        if (localStorage) {
            // TODO: The following line will need to be modified for tasks 2-4.
            var passwordToStore = MD5(pass1 + SALT);
...
// MD5 code => https://css-tricks.com/snippets/javascript/javascript-md5/, Chris Coyier
